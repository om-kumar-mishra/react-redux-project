...
const Login = () => {
  ...
  async function login() {
    ...
    const res= await fetch("http://localhost:301/user-login", {
      method: 'POST',
      headers: {
    ...
    if(json.data)
    {
      ...
      localStorage.setItem("toast_message", json.message)
      navigate("/")
    }
    else{
      localStorage.setItem("toast_message", json.message)
                ...
                <CCardBody>
                  <CForm>
                    ...
                    <CInputGroup className="mb-3">
                      ...
                      <CFormInput placeholder="Enter Email" value={email} onChange={(e) => { setEmail(e.target.value) }} autoComplete="username" />
                    </CInputGroup>
